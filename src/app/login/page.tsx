              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="min-h-12 w-full rounded-md border border-zinc-200 bg-white px-3 pr-12 text-base text-zinc-900 outline-none placeholder:text-zinc-400 focus:ring-2 focus:ring-emerald-600/20 sm:text-sm"
                    value={password}
                  ...
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md p-2.5 text-zinc-500 hover:bg-zinc-50"
